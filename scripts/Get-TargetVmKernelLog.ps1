...
$Env:_NT_SYMBOL_PATH = "srv*C:\Symbols*https://msdl.microsoft.com/download/symbols;C:\Users\spart\RustroverProjects\xmouseinput-sys\target\debug\gamepad_info_package"
